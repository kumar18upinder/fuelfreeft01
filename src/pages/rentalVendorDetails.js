    ...
    <div id="dealer-store-id">
      ...
      <section className="dealer-banner">
        <div className="dealer-banner-outer">
          ...
          <div className="dealer-header-view">
            <Link className="contact-store-view">view More</Link>
          </div>
        </div>
      </section>
      ...
      <div className="vehicles-you-found" ref={scRef}>
        <div className="dealer-banner-text">
          <h2>Vehicles You Will Get</h2>
        </div>
        <div className="dealer-banner-text-p">
          <p>
            Leading analytics have made us one of the most acclaimed E-commerce
            Platforms.
          </p>
        </div>
        <div className="What-you-will">
          <h3 className="not-available">No Vehicle Available</h3>
        </div>
      </div>
      ...
      <div className="store-image-outer" ref={seRef}>
        <div>
          ...
          <Link className="contact-sto">See More</Link>
        </div>
...
export default RentalDealerDetails;
