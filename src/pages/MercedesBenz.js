...
import Benz from "../pages/images/benzbanner.jpeg";
...
export const MercedesBenz = ({ handleclick }) => {
  ...
  async function getCycleList() {
    let resultCycle = await axios.get(
      "http://localhost:5000/product/brand?Brand=mercedes",
      {
        headers: {
          Accept: "application/json",
        },
  ...
  return (
    <div>
      <Header />
      <img src={Benz} alt="Benz banner"></img>

      {/* ---------------------------------our product------------------------------- */}
      <div className="tanker">
        <div class="mobile-section-headfing">
          <span></span>
          <h3>MercedesBenz E-Vehicle</h3>
          <span></span>
        </div>
      </div>
      <div className="tanker">
