...
import pureev from "../pages/images/pureEvBanner.png";
...
export const Pureev = ({ handleclick }) => {
  ...
  async function getCycleList() {
    let resultCycle = await axios.get(
      "https://app.fuelfree.in/product/brand?Brand=pure",
      {
        headers: {
  ...
  const setId = async (productID) => {
    ...
    try {
      let Addtofavorite = await axios.post(
        `https://app.fuelfree.in/favorite/add/${uid}/${pId}`,
        {
          headers: {
            Accept: "application/json",
          },
  ...
  const getfilter = async () => {
    ...
    let res = await axios.get(
      `https://app.fuelfree.in/product/brand?Brand=pure&${DrivingRangeProduct}${maxPrice}`,
      {
        headers: {
          Accept: "application/json",
        },
  ...
  const bikePrices = [
    ...
    { productPrice: "140000", productPriceK: "140k" },
    { productPrice: "160000", productPriceK: "160k" },
  ...
  return (
    <div>
      <Header />
      <img src={pureev} alt="MercedesBenz motors" />
      {/* ---------------------------------our cycles------------------------------- */}
      <div className="tanker">
        <div class="mobile-section-headfing">
          <span></span>
          <h3>Pure E-Vehicle</h3>
          <span></span>
        </div>
      </div>
      <div className="tanker">
