    ...
    <div>
      ...
      <div className="tanker">
        <p className="termsandconditions-all">
          <h3 className="termsand-heading">Privacy Policy of FuelFree</h3>
          At www.fuelfree.in, accessible from https://fuelfree.in/, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by www.fuelfree.in and how we use it. If you have additional questions
          ...
          the information that they shared and/or collect in www.fuelfree.in.
          This policy is not applicable to any information collected offline or
          via channels other than this website.
          <h3 className="termsandconditions-heading">Consent</h3>
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
          <h3 className="termsandconditions-heading">Information we collect</h3>
          ...
          <h3 className="termsandconditions-heading">Log Files</h3>
          www.fuelfree.in follows a standard procedure of using log files. These
          ...
          Like any other website, www.fuelfree.in uses "cookies". These cookies
          ...
          advertising partners of www.fuelfree.in. Third-party ad servers or ad
          ...
          on www.fuelfree.in, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that www.fuelfree.in has
          no access to or control over these cookies that are used by
          third-party advertisers.
          <h3 className="termsandconditions-heading">
            Third Party Privacy Policies
          </h3>
          www.fuelfree.in's Privacy Policy does not apply to other advertisers
          ...
          <h3 className="termsandconditions-heading">Children's Information</h3>
          Another part of our priority is adding protection for children while
          using the internet. We encourage parents and guardians to observe,
          participate in, and/or monitor and guide their online activity.
          www.fuelfree.in does not knowingly collect any Personal Identifiable
          ...
          page.
          <h3 className="termsandconditions-heading">Contact Us</h3>
