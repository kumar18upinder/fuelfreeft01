...
const LogisticsUpdate = () => {
  ...
  const validationSchema =yup.object().shape({
    ...
    topSpeed:yup.number().positive("Please Enter Positive number").required("Top Speed is required"),
     payloadCapacity: yup.number().positive("Please Enter Positive number").required("Payload Capacity is required"),
    seatingCapacity:yup.number().positive("Please Enter Positive number").required("Seating Capacity is required"),
    airbags:yup.number().positive("Please Enter Positive number").required("Airbag number is required"),
    ...
    // headLight:yup.string().required("HeadLight is required"),
              ...
              >
                <Form>
                  <div id="full-add-product">
                    ...
                    <div className="admin-input">
                      <label>Airbags(in number)</label>
                      <Field
                        type="number"
                        name="airbags"
                        placeholder="Airbags(in number)"
                        className="form-control"
                      />
                      <p className="text-danger">
                        <ErrorMessage name="airbags" />
                      </p>
                    </div>
                    <div className="admin-input">
