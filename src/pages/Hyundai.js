...
import hyundai from "../pages/images/hyundai.png";
...
const Hyundai = ({ handleclick }) => {
  ...
  async function getCycleList() {
    let resultCycle = await axios.get(
      "https://app.fuelfree.in/product/brand?Brand=hyundai",
      {
        headers: {
  ...
  const getfilter = async () => {
    ...
    let res = await axios.get(
      `https://app.fuelfree.in/product/brand?Brand=hyundai&${DrivingRangeProduct}${maxPrice}`,
      {
        headers: {
          Accept: "application/json",
        },
