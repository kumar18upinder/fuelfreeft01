...
function Viewtestdrivebookingdetails() {
  const { id } = useParams();
  //testdrive//
  ...
  const getBookings = async () => {
    let res = await axios.get(
      `https://app.fuelfree.in/testDrive/detail/${id}`,
      {
        header: {
    ...
    <>
      ...
      <div id="testdrive-detail-id">
        ...
        <div className="test-drive-details">
          <h1 className="heading-details-outer-test">Testdrive Details</h1>
          ...
          <div className="test-drive-booking">
            <h3 className="main-heading-order-details">Preffered Date</h3>
            <p className="main-detail-data">
...
export default Viewtestdrivebookingdetails;
