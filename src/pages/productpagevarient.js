...
const Productpagevarient = () => {
  ...
  async function getProductdetails() {
    ...
    let details = data.variantDetails;
    setDetails(details);
  }
...
export default Productpagevarient;
